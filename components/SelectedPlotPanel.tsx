...
export function SelectedPlotPanel({
  ...
  return (
    <motion.aside
      ...
      className="glass-panel subtle-scrollbar absolute right-4 top-4 z-20 flex max-h-[calc(100vh-2rem)] w-[360px] flex-col overflow-y-auto rounded-2xl p-5 max-lg:bottom-4 max-lg:top-auto max-lg:w-[calc(100%-2rem)]"
    >
...
function Detail({
  ...
  return (
    <div
      className={`rounded-xl border border-white/10 bg-white/[0.05] p-3${wide ? " col-span-2" : ""}`}
    >
